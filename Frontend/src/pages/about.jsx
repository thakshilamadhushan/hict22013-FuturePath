...
import "./about.css";
import { Sparkles, Globe, Shield, Target, Users } from "lucide-react";
    ...
    <div >
      ...
      <div className="missionsection">
        <div className="mission-left">
          ...
          <p>
            FuturePath uses state-of-the-art AI to understand what candidates
            are actually capable of — not just what keywords appear on their
            resume — and match them with roles where they'll genuinely thrive.
          </p>
      ...
      <div className="join-section">
        <div className="join-card">
          ...
          <p>
            We're a team of 60+ people across SF, London, and Singapore. We're
            hiring across engineering, design, and growth.
          </p>
